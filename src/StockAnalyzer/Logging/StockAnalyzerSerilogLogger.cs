...
namespace StockAnalyzer.Logging {
    [Serializable]
    public class StockAnalyzerSerilogLogger : MarshalByRefObject, Logger {
        private static readonly Type declaringType = typeof(StockAnalyzerSerilogLogger);       

        public StockAnalyzerSerilogLogger(Serilog.ILogger logger, StockAnalyzerSerilogFactory factory) {
        ...
        internal StockAnalyzerSerilogLogger() {
        }
        ...
        protected internal StockAnalyzerSerilogFactory Factory { get; set; }
