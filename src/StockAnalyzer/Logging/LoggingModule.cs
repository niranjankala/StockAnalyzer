...
namespace StockAnalyzer.Logging
{
    ...
    public class LoggingModule : Module
    {
        ...
        {
            // by default, use StockAnalyzer's logger that delegates to Castle's logger factory
            ...
            {
                moduleBuilder.RegisterType<StockAnalyzerLog4netFactory>().As<Castle.Core.Logging.ILoggerFactory>().InstancePerLifetimeScope();
            }
            else
            {
                moduleBuilder.RegisterType<StockAnalyzerSerilogFactory>().As<Castle.Core.Logging.ILoggerFactory>().InstancePerLifetimeScope();
            }
