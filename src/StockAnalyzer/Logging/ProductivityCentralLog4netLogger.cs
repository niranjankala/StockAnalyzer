...
namespace StockAnalyzer.Logging {
    [Serializable]
    public class StockAnalyzerLog4netLogger : MarshalByRefObject, Logger {
        private static readonly Type declaringType = typeof(StockAnalyzerLog4netLogger);       

        public StockAnalyzerLog4netLogger(log4net.Core.ILogger logger, StockAnalyzerLog4netFactory factory) {           
            Logger = logger;
            Factory = factory;
        }

        internal StockAnalyzerLog4netLogger() {
        }

        internal StockAnalyzerLog4netLogger(ILog log, StockAnalyzerLog4netFactory factory)
        ...
        protected internal StockAnalyzerLog4netFactory Factory { get; set; }
